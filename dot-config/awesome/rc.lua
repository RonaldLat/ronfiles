...
local terminal         = os.getenv("TERMCMD") or "terminology"
...
local mytextclock = wibox.widget.textclock(beautiful.widget_markup:format(beautiful.bg_normal, "%H:%M:%S"), 1)
...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- local ram_widgy = awful.widget.watch('bash -c "free -h | awk \'/^Mem/ {print $3}\'"', 30)
  s.mywibox:setup {
    { -- Left widgets
      mylauncher,
      s.mytaglist,
...
-- awful.spawn.with_shell("dex --enviroment Awesome --autostart")
